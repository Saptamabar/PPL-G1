            ...
            <nav>
                <ul>
                    ...
                    <li class="mb-2 relative group">
                            <a href="#" class="flex items-center justify-between px-4 py-2 rounded hover:bg-primary-600 {{ request()->routeIs(['inventariskaryawan-habis.*','inventariskaryawan-tak-habis.*']) ? 'bg-primary-600' : '' }}">
                                Inventaris
                            ...
                            <ul class="ml-4 mt-1 hidden group-hover:block bg-primary-800 rounded">
                                <li class="mb-1">
                                    <a href="{{ route('inventariskaryawan-habis.index') }}" class="block px-4 py-2 rounded hover:bg-primary-600 {{ request()->routeIs(['inventariskaryawan-habis.*']) ? 'bg-primary-600' : '' }}">
                                        Inventaris Habis
                                    </a>
                                </li>
                                <li class="mb-1">
                                    <a href="{{ route('inventariskaryawan-tak-habis.index') }}" class="block px-4 py-2 rounded hover:bg-primary-600 {{ request()->routeIs(['inventariskaryawan-tak-habis.*']) ? 'bg-primary-600' : '' }}">
